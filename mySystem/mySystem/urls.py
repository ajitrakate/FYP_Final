...
from myapp.views import home, about, contact, doctors, SignUpView, PatientSignUpView, DoctorSignUpView, dashboard, dashDoctors, createAppointment, allAppointments, profile, cancel, bookAppointment, book, approve,reject, myECGView, getData, myPatients,patientECG
...
urlpatterns = [
    ...
    path('dashboard/myecgview', myECGView, name='myECGView'),
    path('dashboard/myecgview/getData/<int:n>', getData, name='getData'),
    path('dashboard/patientECGView/getData/<int:n>', getData, name='getDataPatient'),
    path('dashboard/myPatients', myPatients, name='myPatients'),
    path('dashboard/ecg/<int:pk>', patientECG, name='patientECG'),
